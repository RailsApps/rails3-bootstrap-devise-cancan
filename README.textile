...
If you're storing the app in a GitHub repository, please edit the README file to add a description of the app and your contact info. If you don't change the README, people will think I am the author of your version of the application.
...
You'll need to modify the files *config/environments/development.rb* and *config/environments/production.rb* to include your Gmail username and password.

...
<pre>
user2 = User.find_or_create_by_name :name => 'Second User', :email => 'user2@example.com', :password => 'please', :password_confirmation => 'please'
...
You may wish to set up SSL before you make your application available in production. See the "Heroku documentation on SSL":https://devcenter.heroku.com/articles/ssl.
...
Alternatively, you can set Heroku environment variables like this:
